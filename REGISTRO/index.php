...
<body>
<header id="header_img_sesion" style="background: url(../imagenes/11.jpeg);background-position: center;background-attachment: contain;  background-size: cover;background-color: rgba(0,0,0,0.7);">
...
<h1 style="margin-top: 220px; color: #fff; margin-left: 30px;"><b>REGISTRO</b></h1>
</header>
...
<div class="container">
  ...
  <form action="../BD/insert_user.php" method="POST">

  <div class="form-group">
    <label for="exampleInputEmail1"><h4><b>NOMBRE COMPLETO</b></h4></label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nombre" placeholder="Ingrese el nombre completo">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1"><h4><b>IDENTIFICACIÓN</b></h4></label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="identificacion" placeholder="Ingrese el # de indentificación">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1"><h4><b>CELULAR</b></h4></label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="celular" placeholder="Ingrese el numero telefonico">
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1"><h4><b>CORREO ELECTRONICO</b></h4></label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" placeholder="Ingrese Correo Electronico">
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1"><h4><b>CONTRASEÑA</b></h4></label>
    <input type="password" name="clave1" class="form-control" id="exampleInputPassword1" placeholder="Ingrese La Clave">
  </div>

  <div class="form-group">
    <label for="exampleInputPassword1"><h4><b>CONFIRMAR CONTRASEÑA</b></h4></label>
    <input type="password" name="clave2" class="form-control" id="exampleInputPassword1" placeholder="Confirme La Clave">
  </div>

  <button type="submit" class="btn btn-success btn-lg"><b>REGISTRARSE</b></button>
</form>
</div>
</div>  
