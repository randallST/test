...
<center>
   <br>
    ...
    <?php 
       ...
       $query = "SELECT * FROM t_datos_generales WHERE id_tipo_datos = 2";
  ...
  background-image: url(../imagenes/img_contenido/<?php echo $sf['foto_titular'];  ?>);">  
    ...
    <div id="info"><br>
      <a href="../DETALLE/index.php?id=<?php echo $sf['id_datos']; ?>">
        <h1><p id="nono" style="font-weight: bold;font-size: 20px;">
...
La península de Osa, junto con la Bahía de Drake se ha convertido en el primer destino de turismo ecológico en la provincia.
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled mb-0">
          ...
          <li>
            <a href="#" class="text-white">COMERCIO</a>
          </li>
          <li>
