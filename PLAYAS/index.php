...
<body>
<header id="header_img" style="/*background: url(../imagenes/playa1.jpg);background-position: center;background-attachment: contain;  background-size: cover;background-color: rgba(0,0,0,0.7);*/">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h2 style="color:#000; font-weight: bold; color: #052A6C;">
...
<center>
    ...
    <?php 
       $query = "SELECT * FROM t_datos_generales WHERE id_tipo_datos = 1";
  ...
  background-image: url(../imagenes/img_contenido/<?php echo $sf['foto_titular'];  ?>);"> 
    ...
    <div id="info" style="background-image: url(../imagenes/<?php echo $sf['foto_titular'];  ?>);"><br>
...
La península de Osa, junto con la Bahía de Drake se ha convertido en el primer destino de turismo ecológico en la provincia.
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        ...
        <ul class="list-unstyled mb-0">
          <li>
            <a href="#" class="text-white">PLAYAS</a>
          </li>
          <li>
